...
<%@page import="com.siyu.oa.global.Contant" %>
<jsp:include page="top.jsp"/>

<section id="content" class="table-layout animated fadeIn">
    <script type="text/javascript" src="/js/switch_claimVoucher.js"></script>
    <script>
        window.onload(switchClaimVoucher(1));
    </script>
                ...
                <div class="panel-menu">
                    <div class="row">
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                <button type="button" onclick="window.location.reload()" class="btn btn-default light">
